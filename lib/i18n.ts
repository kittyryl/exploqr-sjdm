...
const UI = {
  ...
  "feedback.photo": "Attach a photo (optional)",
  "feedback.photo.cta": "Choose photo",
  "feedback.photo.remove": "Remove",
  "feedback.photo.error.type": "Please attach an image file.",
  "feedback.photo.error.size": "Image is too large — please keep it under 5MB.",
